...
) -> Annotated[LineSegment, "Line segment connecting the points with computed length"]:
...
if __name__ == "__main__":
    ...
    print(
        "This is potentially dangerous. Ensure you are running this in a safe environment."
    )
    ...
    print_stats(
        _implementation_cache["check_if_integer_is_prime"], "check_if_integer_is_prime"
    )
